...
def classic_control(env):
    ...
    learn_params = dict(env=env, train_episodes=500, test_episodes=10, max_steps=200, save_interval=10,
                        mode='train', render=False, gamma=0.9, a_update_steps=10, c_update_steps=10,
